 ...
 * system settings of the Android device. Once a device is paired, you communicate with it.
 * <p>
 * Please note that Qt 5.3 supports bluetooth on Android out of the box.
 * This class may be used as an alternative on Qt 5.0 ... 5.2. It will possibly also work in future versions.
 * <p>
...
public:
     ...
     * @param address Name or address of the device, e.g. "HC-06" or "20:13:11:15:16:08". Using the address is better because it's unique.
    ...
    /**
     * Query how many bytes have been received and buffered until now.
